...
export default function BlogSingle() {
  return (
    <>
      <div className="py-5 w3l-homeblock1 text-center">
          ...
          <div className="container pb-lg-4">
            <div className="single-post-image">
              <div className="post-content">
                <img
                  src="assets/images/blogsingle.jpg"
                  className="radius-image img-fluid mb-5"
                  alt=""
                />
              </div>
            </div>
            <div className="single-post-content">
              ...
              <div className="sing-post-thumb mb-5 row pt-3">
              ...
              <h3 className="blog-desc-big m-0 mb-lg-4 mb-3">
